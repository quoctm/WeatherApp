...
class AddNewLocationRedux extends React.Component<AddNewLocationProps, AddNewLocationState> {
    ...
    processLocation (text: string) {
        ...
        if (isNumber && (zipcode as number).toString() === text && text.length === 5 && zipcode >= 10000 && zipcode <= 99999) {
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={styles.messageView}>
                            <Text style={styles.messageTextStyle}>
                                {(this.state.inputText.length > 0) ? 'Invalid zipcode ' + this.state.inputText : ' ' + '10000 <= zipcode <= 99999'}
                            </Text>
                        </View>
                        <TouchableOpacity
